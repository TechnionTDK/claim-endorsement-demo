...
def hypdb_responsibility_scores(attr_list):
    d = {"FER": 0.2706, "DRAT": 0.2690, "CITWP": 0.2450, "ENG": 0.202, "DREM": 0.0135, "HINS1": 1.31 * 10**(-5)}
    s = 0
...
def bucketize_ACS_dataset(df):
    #numeric = ["AGEP", 'CITWP', 'JWMNP', 'MARHYP', 'WKHP', 'YOEP', 'JWAP', 'JWDP']
    buckets = {'AGEP': Bucket(0, 100, 10), 'CITWP': Bucket(1930, 2020, 9), 'JWMNP': Bucket(0, 170, 17),
               'MARHYP': Bucket(1930, 2020, 9), 'WKHP': Bucket(0, 100, 10), 'YOEP': Bucket(1920, 2020, 10),
               'JWAP': Bucket(0, 290, 29), 'JWDP': Bucket(0, 150, 15)}
    # how to transform a numeric bucket into discretized?
...
if __name__ == '__main__':
    ...
    if RUN_ACTUAL_CP:
        ...
        methods = ['original_order', 'HYPDB',
                   'random_shuffle:1', 'random_shuffle:2', 'random_shuffle:3',
                   'ALL_TOP_K_MERGED',
